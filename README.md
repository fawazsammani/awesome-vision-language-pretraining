...
- **[PaLI]** A Jointly-Scaled Multilingual Language-Image Model [[pdf]](https://arxiv.org/pdf/2209.06794.pdf) [[blog]](https://ai.googleblog.com/2022/09/pali-scaling-language-image-learning-in.html)
...
- **[DALL-E 3]** [[pdf]](https://cdn.openai.com/papers/dall-e-3.pdf) [[consistency decoder]](https://github.com/openai/consistencydecoder) [[website]](https://openai.com/dall-e-3)
...
- **[KOSMOS-2]** Grounding Multimodal Large Language Models to the World [[pdf]](https://arxiv.org/pdf/2306.14824.pdf) [[code]](https://github.com/microsoft/unilm/tree/master/kosmos-2) [[code]](https://huggingface.co/docs/transformers/model_doc/kosmos-2) [[code]](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/KOSMOS-2/Inference_with_KOSMOS_2_for_multimodal_grounding.ipynb)
...
- **[LLaVA-Interactive]** Image Chat, Segmentation and Generation/Editing -- All-in-one demo [[pdf]](https://arxiv.org/pdf/2311.00571.pdf) [[code]](https://github.com/LLaVA-VL/LLaVA-Interactive-Demo) [[website]](https://llava-vl.github.io/llava-interactive/) [[demo]](https://llavainteractive.ngrok.io/)
...
- **[SigLIP]** Sigmoid Loss for Language Image Pre-Training [[pdf]](https://arxiv.org/pdf/2303.15343.pdf) [[code]](https://github.com/google-research/big_vision) [[colab demo]](https://colab.research.google.com/github/google-research/big_vision/blob/main/big_vision/configs/proj/image_text/SigLIP_demo.ipynb)
...
- **[X-CLIP]** End-to-End Multi-grained Contrastive Learning for Video-Text Retrieval [[pdf]](https://arxiv.org/pdf/2207.07285.pdf) [[code]](https://github.com/xuguohai/X-CLIP) [[code]](https://huggingface.co/docs/transformers/model_doc/xclip)
...
- **[Grounded-SAM]** Grounded-Segment-Anything [[project]](https://github.com/IDEA-Research/Grounded-Segment-Anything) [[colab]](https://colab.research.google.com/github/roboflow-ai/notebooks/blob/main/notebooks/automated-dataset-annotation-and-evaluation-with-grounding-dino-and-sam.ipynb) [[colab]](https://github.com/camenduru/grounded-segment-anything-colab) [[video]](https://www.youtube.com/watch?v=oEQYStnF2l8&ab_channel=Roboflow) [[demo]](https://huggingface.co/spaces/yizhangliu/Grounded-Segment-Anything) [[demo]](https://huggingface.co/spaces/IDEA-Research/Grounded-SAM) [[notebook]](https://github.com/IDEA-Research/Grounded-Segment-Anything/blob/main/grounded_sam.ipynb)
- **[SEEM]** Segment Everything Everywhere All at Once [[pdf]](https://arxiv.org/pdf/2304.06718.pdf) [[code]](https://github.com/UX-Decoder/Segment-Everything-Everywhere-All-At-Once) [[demo]](http://semantic-sam.xyzou.net:6090/)
- **[Semantic-SAM]** Segment and Recognize Anything at Any Granularity [[pdf]](https://arxiv.org/pdf/2307.04767.pdf) [[code]](https://github.com/UX-Decoder/Semantic-SAM) [[demo]](http://semantic-sam.xyzou.net:6098/) [[demo]](http://semantic-sam.xyzou.net:6080/)
...
- GPT-4V(ision) System Card [[pdf]](https://cdn.openai.com/papers/GPTV_System_Card.pdf)
